    ...
    <el-table
      ...
      >
        <template scope="scope">
          <div :style="scope.row.finish_status === 'TASK_STATUS_001' ||  scope.row.finish_status === 'TASK_STATUS_000' || scope.row.finish_status === 'TASK_STATUS_003'? 'display: inline-block' : 'display:none'">
            <el-button
              size="mini"
